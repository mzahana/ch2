...
ros::Publisher pub_range1( "sonar_side_back", &range_msg1);
ros::Publisher pub_range2( "sonar_side_mid_t", &range_msg2);
ros::Publisher pub_range3( "sonar_side_mid_b", &range_msg3);
ros::Publisher pub_range4( "sonar_side_front", &range_msg4);
ros::Publisher pub_range5( "sonar_front_r", &range_msg5);
ros::Publisher pub_range6( "sonar_front_l", &range_msg6);
ros::Publisher pub_range7( "sonar_tip", &range_msg7);
...
float getRange7(int pingPin7){
    ...
    duration = pulseIn(pingPin7, HIGH);
    cm = duration / 29 / 2;
    m = cm / 100;
...
void setup(){
  ...
  range_msg7.field_of_view = 0.25;
  range_msg7.min_range = 0.02;
  range_msg7.max_range = 2;
}
...
void loop(){
  ...
  if ( (millis()-range_timer) > 100){
    ...
    range_msg7.range = getRange7(pingPin7);
    ...
    range_msg7.header.stamp = pingsens.now();
